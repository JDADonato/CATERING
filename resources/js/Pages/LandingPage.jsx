...
const LandingPage = () => {
    ...
    const links = [{ n:'Home',p:'/' },{ n:'Menu',p:user?'/menu':'/register' },{ n:'Book Now',p:user?'/book':'/register' },{ n:'About',p:'/about' },{ n:'Contact',p:'/contact' }];
                    ...
                    <div className="flex items-center justify-between" style={{height:68}}>
                        ...
                        <div className="hidden md:flex items-center gap-7">
                            ...
                            {user ? (<>
                                ...
                                <Link href={dash()} className="text-white/80 hover:text-[#f0aa0b] text-[13px] font-medium uppercase tracking-widest transition-colors">Dashboard</Link>
                                <button onClick={logout} className="text-white/60 hover:text-white text-xs font-medium py-2 px-5 rounded-full border border-white/20 hover:border-white/40 transition-all">Logout</button>
                            </>) : (<>
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto px-5 sm:px-8 py-20 flex flex-col lg:flex-row items-center gap-12">
                    <div className="flex-1 text-center lg:text-left">
                        ...
                        <div style={{opacity:0,animation:'fadeUp .7s .7s forwards'}}>
                            <button onClick={()=>router.get(user?'/book':'/register')} className="glow-gold bg-[#f0aa0b] hover:bg-[#d4950a] text-[#1a1a1a] font-bold py-4 px-10 rounded-full text-sm uppercase tracking-wider transition-all shadow-lg hover:shadow-xl">
                                Book Eloquente Now →
                            </button>
                        </div>
                    </div>
            ...
            <section className="clip-slant-top clip-slant-bot bg-[#faf7f2] py-32 -mt-8">
                <div className="max-w-6xl mx-auto px-5 sm:px-8">
                    ...
                    <Rv><div className="text-center mt-10">
                        <Link href={user?'/menu':'/register'} className="inline-flex items-center gap-1.5 text-[#720101] hover:text-[#f0aa0b] font-semibold text-sm transition-colors group">
            ...
            <section className="relative py-28 overflow-hidden" style={{background:'linear-gradient(135deg,#720101 0%,#4a0000 50%,#1a1a1a 100%)'}}>
                ...
                <div className="relative z-10 max-w-xl mx-auto px-5 text-center">
                    <Rv>
                        ...
                        <button onClick={()=>router.get(user?'/book':'/register')} className="glow-gold bg-[#f0aa0b] hover:bg-[#d4950a] text-[#1a1a1a] font-bold py-4 px-12 rounded-full text-sm uppercase tracking-wider transition-all shadow-lg hover:shadow-xl">
                            Book Eloquente Now →
                        </button>
                    </Rv>
                </div>
