...
const CATEGORY_LIMITS = { starters: 3, mains: 4, sides: 4, desserts: 4, drinks: 3 };
                    ...
                    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                        <div className="flex flex-col md:flex-row items-center gap-6 p-6 md:p-8">
                            ...
                            <button
                                onClick={() => {
                                    if (!user) {
                                        toast.info('Please sign in to build a custom package.');
                                        router.get('/login');
                                        return;
                                    }
                            ...
                            >
                                ...
                                {user ? 'Start Building' : 'Sign In to Build'}
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div className="fixed inset-0 z-[9998] flex items-end sm:items-center justify-center bg-black/50 backdrop-blur-sm" onClick={() => setShowPackageDrawer(false)}>
                    ...
                    >
                        ...
                        <div className="p-6 border-t border-gray-100 space-y-3">
                            ...
                            <button
                                onClick={() => {
                                    setPackageSelections({ starters: [], mains: [], sides: [], desserts: [], drinks: [] });
                                    setShowPackageDrawer(false);
                                }}
